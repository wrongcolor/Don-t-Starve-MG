local assets =
{
    Asset("ANIM", "anim/huntersspade.zip"), -- PLACEHOLDER: substitua pelo build real (ver README)
    Asset("ANIM", "anim/swap_huntersspade.zip"), -- PLACEHOLDER: aparência na mão, ver README
    Asset("INV_IMAGE", "huntersspade"),
}

local function onequip(inst, owner)
    owner.AnimState:OverrideSymbol("swap_object", "swap_huntersspade", "swap_huntersspade")
...
local function fn()
    ...
    inst.AnimState:SetBank("huntersspade")
    inst.AnimState:SetBuild("huntersspade")
    ...
    inst.components.finiteuses:SetMaxUses(TUNING.HUNTERSSPADE_USES)
    inst.components.finiteuses:SetUses(TUNING.HUNTERSSPADE_USES)
...
return Prefab("huntersspade", fn, assets, prefabs)
