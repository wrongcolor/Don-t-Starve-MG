...
local function fn()
    ...
    inst.AnimState:SetBank("pighouse")
    inst.AnimState:SetBuild("pighouse")
    ...
    inst.components.spawner:Configure("pigman", TUNING.RESIDENTDEN_RESPAWN_DELAY)

    return inst
end

return Prefab("residentden", fn, assets, prefabs)
